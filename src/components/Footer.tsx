...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative pt-20 pb-10 bg-zinc-950 overflow-hidden border-t border-zinc-800">
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="bg-zinc-900 p-3 rounded-full hover:bg-purple-600/20 hover:border-purple-500/30 border border-zinc-800/50 transition-all duration-300 group hover-lift"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-zinc-900 p-3 rounded-full hover:bg-cyan-600/20 hover:border-cyan-500/30 border border-zinc-800/50 transition-all duration-300 group hover-lift"
              >
              ...
              <a 
                ...
                className="bg-zinc-900 p-3 rounded-full hover:bg-pink-600/20 hover:border-pink-500/30 border border-zinc-800/50 transition-all duration-300 group hover-lift"
              >
            ...
            <form className="space-y-4">
              <div className="relative group">
                <input 
                  ...
                  className="w-full bg-zinc-900/50 border border-zinc-800/50 text-gray-300 rounded-xl px-5 py-3 outline-none focus:border-purple-500/50 transition-all duration-300"
                />
        ...
        <div className="border-t border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <button 
              onClick={scrollToTop}
              className="ml-6 bg-gradient-to-r from-purple-600/20 to-cyan-600/20 p-3 rounded-full border border-zinc-800/50 hover:border-purple-500/30 transition-all duration-300 hover-lift animate-glow"
